...
<body>
        ...
        <tbody>
            <?php foreach ($karyawan as $row) : ?>
                <tr>
                    ...
                    <td><?= $row['id_admin1']; ?></td>
                    <td>
                    <a href=<?= base_url("karyawan/edit/{$row['id_karyawan']}"); ?> class ="new">
                            Edit
                        </a> ||
                        <a href=<?= base_url("karyawan/delete/{$row['id_karyawan']}"); ?> class ="new">
                            Delete
                        </a>
                    </td>
                </tr>
    ...
    <a href=<?= base_url("karyawan/add_new"); ?> class="new">
        Input Data </a><br><br>
    </a>
