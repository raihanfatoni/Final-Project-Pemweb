...
<center><body>
    ...
    <div class="box">
        <h3>ADD Karyawan</h3>
        <div><label>ID : </label><input type="text" name="id_karyawan" class="form-control"></div>
        <div><label>Nama : </label><input type="text" name="Nama" class="form-control"></div>
        <div><label>Kerja: </label><input type="text" name="RanahKerja" class="form-control"></div>
        ...
        <div><label>ID Admin: </label><input type="text" name="id_admin1" class="form-control"></div>
