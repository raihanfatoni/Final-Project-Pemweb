...
<body>
        ...
        <tbody>
            <?php foreach ($pengurus as $row) : ?>
                <tr>
                    ...
                    <td><?= $row['id_admin2']; ?></td>
                    <td>
                    <a href=<?= base_url("pengurus/edit/{$row['id_pengurus']}"); ?> class ="new">
                            Edit
                        </a> ||
                        <a href=<?= base_url("pengurus/delete/{$row['id_pengurus']}"); ?> class ="new">
                            Delete
                        </a>
                    </td>
                </tr>
    ...
    <a href=<?= base_url("pengurus/add_new"); ?> class="new">
        Input Data </a><br><br>
    </a>
